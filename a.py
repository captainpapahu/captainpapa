...
# Bot Configuration
TELEGRAM_BOT_TOKEN = '8311115936:AAEUJpD_glyz4qQ9QIXXBtDh4xxZGNVcxlA'
OWNER_ID = 8208249535  # 👈 Put your real Telegram user ID here
CO_OWNERS = []  # List of user IDs for co-owners
OWNER_CONTACT = "Contact to buy keys"
ALLOWED_GROUP_IDS = [-1003039100431]
MAX_THREADS = 1000
max_duration = 120
bot_open = False
OWNER_USERNAME = "CAPTAINPAPAHU"
...
async def generate_special_key_format(update: Update, context: CallbackContext):
    ...
    await update.message.reply_text(
        ...
        f"👑 *Bot Owner:* CAPTAIN PAPA KA BOT\n\n"
...
application = Application.builder().token("8311115936:AAEUJpD_glyz4qQ9QIXXBtDh4xxZGNVcxlA").build()
